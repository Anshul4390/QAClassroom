...
public class YamlReader {
    ...
    public static String setYamlFilePath() {
        ...
        if (tier.equalsIgnoreCase("dev")) {
        ...
        } else if (tier.equalsIgnoreCase("hris")) {
            yamlFilePath = "src/test/resources/testdata/HRIS_TestData.yml";
          ...
          else if (tier.equalsIgnoreCase("itemservice") || tier.equalsIgnoreCase("production")) {
                yamlFilePath = "src/test/resources/testdata/ITEMSERVICE_TestData.yml";
        } else {
    ...
    public static String getItemYamlValue(String token) {
        try {
            return getValue(token);
        } catch (FileNotFoundException ex) {
            System.out.println(ex.getMessage());
    ...
    public static String getItemServiceData(String token) {
        return getYamlValue(token);
    }
